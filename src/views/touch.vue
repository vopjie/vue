<template>
  <section>
    ...
    v-touch:swipeleft="swipeleftFunc(index)" v-touch:swiperight="swiperightFunc()" v-bind:class="{'swipeleft': isOpen == index}">
      <div class="weui-panel__hd">vue && vue-touch <span class="fr">{{item.name}}</span></div>
      <div class="weui-panel__bd">
        <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg" v-touch:tap="tapFunc(item)">
    ...
    <div class="weui-msg" v-if="!items.length">
      ...
      <div class="weui-msg__text-area">
        <h2 class="weui-msg__title">暂时没有数据哦</h2>
      </div>
    </div>
  </section>
</template>
